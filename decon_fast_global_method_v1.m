...
para.flags.show_loss_flag = 1; % show the loss during deconvlution, disable this will speed up the deconvolution
para.flags.recon_data_flag = 1; % if want the reconstructed XRF data after deconvolution
...
try
    [para,decon_results] = fast_deconvolution_FISTA_v1(para,data_cube,FRI_results,maximum_spectrum,back_noise);
